...
return new class extends Migration
{
    ...
    {
        Schema::create('sdit_settings', function (Blueprint $table) {
            $table->id();
            ...
            // Appearance Settings
            $table->string('color_primary')->default('#ffffff'); // Putih bersih
            $table->string('color_button')->default('#059669'); // Hijau islami modern
            $table->string('color_card')->default('#fef3c7'); // Cream lembut
            ...
            $table->boolean('is_active_achievements')->default(true);
    ...
    {
        Schema::dropIfExists('sdit_settings');
    }
};
