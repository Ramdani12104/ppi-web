...
return new class extends Migration
{
    ...
    {
        Schema::create('ra_settings', function (Blueprint $table) {
            $table->id();
            ...
            // Appearance Settings
            $table->string('color_primary')->default('#F7F1E3'); // Cream hangat
            $table->string('color_button')->default('#7BAE7F'); // Hijau sage lembut
            $table->string('color_card')->default('#FFFDF8'); // Putih tulang
    ...
    {
        Schema::dropIfExists('ra_settings');
    }
};
