...
return new class extends Migration
{
    ...
    {
        Schema::create('mdt_settings', function (Blueprint $table) {
            $table->id();
            ...
            // Appearance Settings
            $table->string('color_primary')->default('#fefaf4'); // Putih tulang / cream hangat
            $table->string('color_button')->default('#2a5f4c'); // Hijau pesantren lembut
            $table->string('color_card')->default('#d6c7b0'); // Coklat kitab / gold islami lembut
    ...
    {
        Schema::dropIfExists('mdt_settings');
    }
};
