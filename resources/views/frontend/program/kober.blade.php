...
<div class="font-sans text-gray-800 bg-[#fefaf0]"> <!-- Soft cream base -->
    ...
    <!-- SECTION: ASATIDZ & ASATIDZAH KOBER -->
        ...
        <div class="max-w-7xl mx-auto">
            <div class="mb-16 text-center flex flex-col items-center">
                <div class="flex items-center gap-4 mb-4 justify-center">
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 uppercase tracking-tight">Asatidz & Asatidzah KOBER</h2>
                    <div class="w-12 h-1 bg-emerald-600"></div>
                </div>
                <p class="text-slate-500 font-medium max-w-2xl">
                    Tenaga pendidik profesional tingkat Kelompok Bermain (KOBER) yang berdedikasi tinggi membimbing tumbuh kembang serta akhlak anak sejak dini.
                </p>
            </div>
            ...
            @if($teachers->isEmpty())
                <div class="text-center py-12 bg-slate-50 rounded-3xl shadow-sm border border-slate-100 max-w-lg mx-auto">
                    ...
                    <p class="text-slate-500 text-sm">Data tenaga pendidik tingkat KOBER sedang disiapkan.</p>
                </div>
            @else
                            ...
                            <div class="p-6 flex-1 flex flex-col text-center">
                                ...
                                <div class="text-left flex-1 flex flex-col">
                                    ...
                                    <p class="text-slate-650 leading-relaxed text-xs flex-1">
                                        {{ $teacher->tasks ?? 'Mendampingi aktivitas motorik halus, pengenalan doa harian, dan pembiasaan islami tingkat KOBER.' }}
                                    </p>
                                </div>
                            </div>
                        </div>
